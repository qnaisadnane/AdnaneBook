...
@section('content')
<div class="max-w-lg">
    <form method="POST" action="{{ route('categories.update', $category->id) }}" class="bg-white rounded-xl border border-slate-200 p-6 shadow-sm space-y-5">
        @csrf @method('PUT')
        <div>
        ...
        <div class="flex gap-3 pt-2">
            <button type="submit" class="bg-primary text-white px-6 py-2 rounded-lg text-sm font-bold hover:bg-primary/90">Update</button>
